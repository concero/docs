...
:::info
Find the list of Concero Router, Verifier and Relayer addresses in [Supported Networks](/integrate-concero/supported-networks?tag=testnet).
:::
...
### 2. Sender & Relayer Checks Run First
